...
const fields = " motif_Intervention,date_Intervention,immat,email, id_pro,id_categories";

class Intervention extends DB {
  constructor(...args) {
    super(...args);
  }
...
module.exports = new Intervention(db, table, fields);
