...
history.push('/displaysearch-page')
setLoading(false)
    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem cs={12} sm={12} md={8}>
          <h2 className={classes.title}>Trouvez un professionnel rapidement</h2>
            ...
            {/* Loading to next page */}
              ...
              <GridItem xs={12} sm={12} md={4}>
                {/* <Link to="/displaysearch-page"> */}
                  <Button color="primary" onClick={handleSubmit}>Rechercher professionnel</Button>
                {/* </Link> */}
              </GridItem>
            </GridContainer>
          </form>
